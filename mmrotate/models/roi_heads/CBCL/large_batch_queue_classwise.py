...
class Large_batch_queue_classwise(nn.Module):
    ...
    def __init__(self, num_classes=37, number_of_instance=2, selection=0.7, feat_len=256):
        """
        Args:
        ...
        with torch.no_grad():
            ...
            for idx, label in enumerate(pid_labels):
                ...
                if 0 <= label < self.num_classes:
                    ...
                    if (torch.max(torch.matmul(self.large_batch_queue[label], features[idx])) < self.selection
